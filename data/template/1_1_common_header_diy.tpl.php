...
<ul>
<li><a href="javascript:;" onclick="spaceDiy.recover();return false;" title="Sao lưu ...">Sao lưu</a></li>
<li><a href="javascript:;" onclick="drag.frameExport();return false;" title="Đang xuất dữ liệu DIY">Xuất DIY</a></li>
<li><a href="javascript:;" onclick="drag.openFrameImport();$('button_more_menu').style.display='none';return false;" title="Đang import dữ liệu DIY">Nhập DIY</a></li>
<li><a href="javascript:;" onclick="drag.blockForceUpdateBatch();$('button_more_menu').style.display='none';return false;" title="Cập nhập dữ liệu trang hiện tại">Cập nhập</a></li>
<li><a href="javascript:;" onclick="drag.clearAll();$('button_more_menu').style.display='none';return false;" title="Xóa tất cả nội dung DIY">Xóa trắng</a></li>
</ul>
</div>
<div id="controlpanel" class="cl hide">
<div id="controlheader" class="cl">
<p class="y">
<span id="navcancel"><a href="javascript:;" id="diycancel" onclick="spaceDiy.cancel();return false;">Đóng</a></span>
<a href="javascript:;" title="Thêm ..." id="button_more" onmouseover="showMenu(this.id);">More</a>
<span id="navsave"><a href="javascript:;" onclick="javascript:spaceDiy.save();return false;">Lưu</a></span>
<span id="button_redo" class="unusable"><a href="javascript:;" onclick="spaceDiy.redo();return false;" title="Làm lại" onfocus="this.blur();">Làm lại</a></span>
<span id="button_undo" class="unusable"><a href="javascript:;" onclick="spaceDiy.undo();return false;" title="Lùi lại" onfocus="this.blur();">Lùi lại</a></span>
<span id="preview" class="unusable"><a href="javascript:;" onclick="spaceDiy.save('preview');return false;" onfocus="this.blur();" title="Xem trước DIY" id="diy_preview">Xem</a></span>
<span id="savecachemsg" class="xg1" style="display: none;"></span>
</p>
<ul id="controlnav">
<li id="navstart" class="current"><a href="javascript:" onclick="spaceDiy.getdiy('start');this.blur();return false;">Bắt đầu</a></li>
...
<?php if(!empty($topic)) { ?>
<li id="navstyle"><a href="javascript:;" onclick="spaceDiy.getdiy('style');this.blur();return false;">Phong cách</a></li>
<li id="navdiy"><a href="javascript:;" onclick="spaceDiy.getdiy('diy', 'topicid', '<?php echo $topic['topicid'];?>');this.blur();return false;">Tùy chọn</a></li>
<?php } ?>
</ul>
<div id="diy_backup_tip" class="tip tip_2" style="display: none;">
<div class="tip_horn"></div>
<div class="tip_c">Bạn có thể sao lưu bằng cách xuất các mẫu &nbsp; <a href="javascript:;" class="xi2" onclick="drag.saveViewTip('diy_backup_tip');return false;">Tôi biết</a></div>
</div>
</div>
<div id="controlcontent" class="cl">
<ul id="contentstart" class="content">
  <li><a href="javascript:;" onclick="spaceDiy.getdiy('frame');return false;"><img src="<?php echo STATICURL;?>image/diy/layout.png" />Thêm frame</a></li>
  <li><a href="javascript:;" onclick="spaceDiy.getdiy('blockclass');return false;"><img src="<?php echo STATICURL;?>image/diy/module.png" />Thêm module</a></li>
  <?php if(!empty($topic)) { ?>
  <li><a href="javascript:;" onclick="spaceDiy.getdiy('style');return false;"><img src="<?php echo STATICURL;?>image/diy/style.png" />Phong cách</a></li>
  <li><a href="javascript:;" onclick="spaceDiy.getdiy('diy', 'topicid', '<?php echo $topic['topicid'];?>');return false;"><img src="<?php echo STATICURL;?>image/diy/diy.png" />Tùy chọn</a></li>
  <?php } ?>
</ul>
...
<span class="y"><a href="javascript:;" onclick="spaceDiy.cancel();return false;" class="xi2">Đóng</a>&nbsp;&nbsp;</span>
