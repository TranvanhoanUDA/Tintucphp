...
<tr><?php $clicknum = 0;?><?php if(is_array($clicks)) foreach($clicks as $key => $value) { ?><?php $clicknum = $clicknum + $value['clicknum'];?><?php $value['height'] = $maxclicknum?intval($value['clicknum']*50/$maxclicknum):0;?><td>
...
<h3 class="mbm xs1">
Người vừa đánh giá (<a href="javascript:;" onclick="show_click('<?php echo $idtype;?>', '<?php echo $id;?>', '<?php echo $key;?>')"><?php echo $clicknum;?>  người</a>)
