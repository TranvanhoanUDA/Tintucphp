...
$lang = array(
	...
	'block4' => 'Kiểu 4',
	'block5' => 'Kiểu 5',
	'blockdata' => array('personalinfo' => 'Thông tin cá nhân', 'profile' => 'Avatar', 'doing' => 'Status', 'feed' => 'Tin tức',
				'blog' => 'Blog',
	...
	'wall_form' => '<div class="space_wall_post">
						<form action="home.php?mod=spacecp&ac=comment" id="quickcommentform_{uid}" name="quickcommentform_{uid}" method="post" autocomplete="off" onsubmit="ajaxpost(\'quickcommentform_{uid}\', \'return_commentwall_{uid}\');doane(event);">
							...
							<input type="hidden" name="commentsubmit" value="true" />' : ($_G['connectguest'] ? '<div class="pt hm">Bạn cần phải <a href="member.php?mod=connect" class="xi2">cập nhật thông tin</a> trước khi trả lời</div>' : '<div class="pt hm">Bạn cần phải đăng nhập trước, <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href)" class="xi2">đăng nhập</a> | <a href="member.php?mod='.$_G['setting']['regname'].'" class="xi2">'.$_G['setting']['reglinkname'].'</a></div>')).'
