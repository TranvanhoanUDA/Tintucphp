        ...
        <div class="col-sm-3 hidden-xs" id="widget">
            ...
            <section class="box wow fadeInDown" data-wow-duration="2s" id="popular-posts-widget">
                ...
                <div class="content">
                    <script type="text/javascript" src="https://ssl.gstatic.com/trends_nrtr/2213_RC01/embed_loader.js"></script> <script type="text/javascript"> trends.embed.renderWidget("dailytrends", "", {"geo":"VN","guestPath":"https://trends.google.com.vn:443/trends/embed/"}); </script> 
                </div>
            </section>
            <!--/ Popular Posts Widget -->
            <!-- Ads Widget -->
