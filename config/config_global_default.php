 ...
 * @example
 * $_config['db']['1']['dbhost'] = 'localhost'; // Dia chi may chu
 * $_config['db']['1']['dbuser'] = 'root'; // Ten tai khoan database
 * $_config['db']['1']['dbpw'] = 'root';// Mat khau database
 * $_config['db']['1']['dbcharset'] = 'utf8';// Charset
 * $_config['db']['1']['pconnect'] = '0';// 是否持续连接
 * $_config['db']['1']['dbname'] = 'x1';// Ten CSDL
 * $_config['db']['1']['tablepre'] = 'pre_';// Prefix
 *
...
// 页面输出设置
$_config['output']['charset'] 			= 'utf-8';	// Charset
...
$_config['output']['language'] 			= 'vi_vn';	// 页面语言 zh_cn/zh_tw
...
$_config['admincp']['founder']			= '1';		// Dien id cua nguoi sang lap. Dien nhieu nguoi thi tach ra = dau ,
