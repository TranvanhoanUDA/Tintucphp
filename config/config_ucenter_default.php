...
// 数据库相关 (mysql 连接时)
define('UC_DBHOST', 'localhost');			// Dia chi may chu UCenter
define('UC_DBUSER', 'root');				// Tai khoan CSDL cua UCenter
define('UC_DBPW', 'root');				// Tai khoan CSDL cua UCenter
define('UC_DBNAME', 'ucenter');				// Ten CSDL cua UCenter
define('UC_DBCHARSET', 'utf8');				// Charset CSDL UCenter
define('UC_DBTABLEPRE', '`ucenter`.uc_');		// Prefix UCenter
