...
<?php
$attrs = 'webSearchSafesearch="none" webSearchResultSetSize="' . $t['items_per_page'] . '"';

if ((int) $t['engine.engine_is_image']) {
    $attrs = 'imageSearchResultSetSize="20" disableWebSearch="1" defaultToImageSearch="1"';
}
?>
<div class="col-md-7 px-2 px-md-3">
    ...
    <gcse:searchresults-only <?= $attrs; ?> mobileLayout="forced" enableOrderBy="1" linkTarget="_blank"  noResultsString="<?= sprintf(__('Your search - %s - did not match any documents', _T), e_attr($t['q'])); ?>">
    <?php insert('partials/placeholder.php'); ?>
