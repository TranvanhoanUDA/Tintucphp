...
class DashboardFeedsController extends DashboardController
{
    ...
    public function createPOST()
    {
        ...
        // This is required if the fulltext is checked
        if ($data['feed_fetch_fulltext']) {
            $required[] = 'feed_fulltext_selector';
        }
        ...
        $v = (new Validator($data))
          ...
          ->rule('lengthMax', 'feed_url', 200)
          ->rule('lengthMax', 'feed_logo_url', 250)
    ...
    public function refreshFeed($id)
    {
        ...
        $feedModel->update($id, ['feed_last_refreshed' => time()]);
